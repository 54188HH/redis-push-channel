...
import com.lzq.redispushchannel.dto.NearbyBO;
import com.lzq.redispushchannel.dto.NearbyPO;
import com.lzq.redispushchannel.dto.Result;
...
public class NearbyBizService {
    ...
    public Result<List<NearbyBO>> nearby(NearbyPO paramObj) {
        ...
        Set<String> redisNearby = redisService.getSetByKeyAndScore(cacheKey, endIndex - EIGHT_HOUR_SECOND, endIndex);
    ...
    private class InsertCache implements Runnable {
        ...
        public void run() {
            ...
            String cacheUserPosition = redisService.getOneStringByKey(userCacheKey);
            // 确保用户坐标信息缓存清除慢于“附近的人”坐标信息
            redisService.setOneStringByKey(userCacheKey, cacheNewData, EIGHT_HOUR_SECOND + 60);

            // 保存用户坐标信息至“附近的人”缓存集合
            redisService.addOneStringToZSet(cacheKey, cacheNewData, cacheUserPosition, endIndex);
        }
